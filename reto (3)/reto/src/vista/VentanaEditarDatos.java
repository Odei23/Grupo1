...
public class VentanaEditarDatos extends JDialog {
    ...
    /*
     * @Erik. Esta ventana de editar es similar a la otra, solo que esta ventana recoge el dni del usuario con el que estamos y nos 
     * plasma la informacion de ese usario menos la contraseña, podremos cambiar todos los datos
     */
    public VentanaEditarDatos(String dni) {
        ...
        btnGuardar.setBounds(575, 408, 162, 45);
    ...
    /*
     * @Erik. Este metodo sirve para mostrar los datos del usuario con el que estamos.
     */
    protected void mostrarDatosUsuario(String dni) {
        ImplementacionBaseDeDatos baseDeDatos = new ImplementacionBaseDeDatos();
        Usuario usuario = baseDeDatos.obtenerUsuarioPorDNI(dni);
        ...
        if (usuario != null) {
            ...
            // Aquí podrías configurar el campo de contraseña si lo deseas
        } else {
    ...
    /*
     * @Erik. Este metodo sirve para volver al menu usuario.
     */
    ...
    /*
     * @Erik. Este metodo sirve para guardar los datos modificados de un usuario 
     * en la base de datos a través del controlador
     */
